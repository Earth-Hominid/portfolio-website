...
const CustomFour = () => {
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="flex flex-col items-center rounded-xltext-black indigo-gradient border-[1px] border-gray-300 shadow-xl space-y-5 dark:bg-[#121212] dark:border-gray-900"
    >
      <Image
        src={ProjectFour}
        alt=""
      ...
      <TechIconContainer>
        ...
        <Image
          ...
          className="h-8 w-8 rounded-lg"
        />
        <Image src={PugLogo} alt="Pug logo" className="h-8 w-8 rounded-lg" />
        <Image
          src={TailwindIcon}

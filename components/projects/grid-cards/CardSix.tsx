    ...
    <>
      {darkMode ? (
        <motion.div
          ...
          viewport={{ once: true }}
          className="flex flex-col items-center rounded-xl border-[1px] shadow-xl space-y-5 bg-[#121212] border-gray-900"
        >
          <Image
            src={ProjectSix}
            alt="Resume Builder Website"
            priority={true}
            className="rounded-t-xl h-auto w-auto"
          />
          <CardTitle className="text-[#03DAC5]">Resume Builder 2.0</CardTitle>
          <TechIconContainer>
            <Image
              src={ReactLogo}
              alt="React logo"
          ...
          <CardDescription>
            Modern React SPA providing users the ability to create their own
            resume. Architected with switch-statements to provide a{' '}
            {`"stepping through process"`}, this one page application has the
            feel of <DarkGreenWavy>multiple</DarkGreenWavy> pages.
          </CardDescription>
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1 }}
          viewport={{ once: true }}
          className="flex flex-col items-center rounded-xl green-gradient border-[1px] shadow-xl border-gray-300 space-y-5 dark:bg-[#121212] dark:border-gray-900"
        >
          <Image
            src={ProjectSix}
            alt=""
          ...
          <CardDescription>
            ...
            {`"stepping through process"`}, this one page application has the
            feel of <BlackWavy>multiple</BlackWavy> pages.
          </CardDescription>

...
const CardOne = () => {
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="flex flex-col items-center rounded-xl text-black bg-yellow-50 dark:bg-[#121212] border-gray-300 border-[1px] shadow-xl space-y-5 flex-shrink-0 dark:border-gray-900"
    >
      <Image
        src={ProjectOne}

...
const CardTwo = () => {
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="flex flex-col items-center rounded-xl text-black bg-indigo-50 dark:bg-[#121212] dark:border-gray-900 border-gray-300 border-[1px] shadow-xl space-y-5"
    >
      <Image
        src={ProjectTwo}
        alt="Project Two"
      ...
      />
      <CardTitle className="text-indigo-600 dark:text-[#BB86FC]">
        Blog Creator API
      </CardTitle>
      <TechIconContainer>
        <Image

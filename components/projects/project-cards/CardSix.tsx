    ...
    <CardArticle className="green-gradient">
      ...
      <TechIconContainer>
        ...
        <Image
          ...
          className="h-7 w-7 rounded-lg"
        />
        <Image src={HtmlLogo} alt="Html5 logo" className="h-7 w-7 rounded-lg" />
        <Image src={CSSLogo} alt="CSS3 Logo" className="h-7 w-7 rounded-lg" />
      </TechIconContainer>
      <Description>
        Blazingly fast modern React SPA. Architected with switch-statements to
        provide a {`"stepping through process"`}, this one page application has
        the feel of <BlackWavy>multiple</BlackWavy> pages.
      </Description>

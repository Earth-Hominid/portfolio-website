...
const CustomThree = () => {
  const GithubIcon = (
    <svg
      className={`h-6 w-6 ml-2 group-hover:fill-black transition duration-300`}
    >
  ...
  return (
    <CardContainer className="text-black bg-[#FFF7F0] border-gray-300 border-[1px] shadow-xl">
      <Image
        src={ProjectThree}
      ...
      <CardDescription>
        ...
        Modern React, Functional Components with Hooks. Simple State management
        with Context API.
      </CardDescription>
      ...
      <ActionButtonHolder>
        <Link href="https://earth-hominid.github.io/Chair-Mart/">
          <a target="_blank">
            <WebsiteButton className="hover:bg-[#ffe0c3] bg-white hover:text-black">
              Website
              <IconHolder>
                <ComputerDesktopIcon />
              </IconHolder>

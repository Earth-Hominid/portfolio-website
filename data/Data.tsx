...
export const ProjectArray = [
  {
    ...
    src: { ProjectOne },
    technology:
      'TypeScript | Node | PostgreSQL | NextJS |  StrapiJS Headless CMS',
    description:
      'An easy to use web application that strengthens business organizations by providing infrastructure for learning and secure collaboration.',
    styles: 'text-black bg-rose-50',
    textColor: 'text-black',
    buttonColor:
      'hover:bg-rose-300 bg-white text-black transition duration-300 hover:text-white',
    fillColor: 'group-hover:fill-white',
    githubAddress:
      'https://github.com/Earth-Hominid/Business-Communication-Platform-Full-Stack',
  ...
  },
  {
    ...
    src: { ProjectTwo },
    technology: 'Node | React | Express | MongoDB | Mongoose ORM',
    description:
      'Designed with Model-View-Controller architecture and the blazingly fast RESTful API framework. Online users can signup for an account. Once authenticated, they can create, save, edit and view blog entries.',
  ...
  },
  {
    ...
    description:
      'With a discord inspired theme, clean UI, MVC architecture and data validation, this ExpressJS Full Stack CRUD application ensures you have full control of your inventory.',
    src: { ProjectFour },
  ...
  },
  {
    ...
    description:
      'A MARVEL themed, one page modern React web app, built with Functional Components and Hooks.',
    src: { ProjectFive },
  ...
  },
  {
    ...
    description:
      'A modern one page web application providing users the ability to produce and format their own resume.',
    src: { ProjectSix },
    technology: 'React | CSS3',
    textColor: 'text-black',
